...
CELERY_ROUTES={
    ...
    'milvus_app.tasks.tranpose_n_topk_results' : {'queue': 'for_query'},
    'milvus_app.tasks.reduce_one_request_files_results' : {'queue': 'for_query'},
    'milvus_app.tasks.reduce_n_request_files_results' : {'queue': 'for_query'},
}
